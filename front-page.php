...
<div id="first-section">
	<img class="first-section__img-absolute" src="<?php echo get_template_directory_uri()?>/img/images/Butterfly-House-By-Feldman-Architecture.jpg" alt="">
	<div class="container">
		<div class="row">
		...
		<img class="bounceOutDown first-section__arrows-down" src="<?php echo get_template_directory_uri()?>/img/images/arrows-down.png" alt="">
</div>
<div id="second-section">
	<div class="container">
		<div class="row">
			<div class="col-lg-6"><img src="<?php echo get_template_directory_uri()?>/img/images/two-block-img.png" alt=""></div>
			<div class="col-lg-6 second-section__text">
				<div><strong>Kraystom </strong>- группа, объединяющая целый ряд компаний, занятых предоставлением услуг в сфере строительства и ремонта. Гарантировано высокое качество работ и цены без переплат, устанавливаемые исполнителями.</div>
			</div>
		</div>
	</div>
</div>
<div id="thirt-section">
	<div class="container">
		<div class="row justify-content-around">
			<div class="col-12 section-title">Возможности на сервисе</div>
...
<div id="four-section">
	<div class="container">
		<div class="row">
			<div class="col-12 section-title">Основные преимущеста сервиса KRAYSTOM</div>
			<div class="col-12 four-section__blocks">
				<div class="four-section__block">
		...
		<div class="row">
			<div class="col-7">
				<div class="five-section__title">
					В какой сфере Kraystom поможет? 
				</div>
				<div class="five-section__text">
					Kraystom поможет решить все задачи, связанны<br>
					с ремонтом, строительством и отделкой.<br>
					Причем масштаб заказа может быть любым – от возведения гигантского особняка, напоминающего средневековый замок, до укладки плитки в ванной.<br>Предлагаем ознакомиться с полным списком услуг,<br>нажав на кнопку ниже. А если необходимое найти не удалось, свяжитесь с нами<br>
					– мы поможем решить ваши задачи!
				</div>
				<div class="five-section__button"><a href="#"><span class="btn">Полный список услуг</span></a></div>	
			</div>
		</div>
	</div>
</div>
...
<div id="thirt-section" class="advance">
	<div class="container">
		<div class="row justify-content-around">
			<div class="col-12 section-title">Возможности на сервисе</div>
			<div class="thirt-section__block">
